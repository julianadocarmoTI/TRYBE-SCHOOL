/* 2) Copie o código abaixo e faça uma função que retorne o array oddsAndEvens
 em ordem crescente.
    ...
    array.sort(). Spoiler: É possível realizar uma função que ordene qualquer array de números.
