...
if (unitCost >= 0 && unitSale >= 0) {
let totalCost = (unitCost * 1.20);
let profitIn1000 = (unitSale - totalCost) * 1000;
x = profitIn1000;
} else {
    x = "ERRO! Os valores não podem ser menor ou igual a zero";
}
console.log("LUCRO VENDA(1000 unid.) = " + x);